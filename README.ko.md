...
플러그인은 Obsidian API와 browser API를 사용하고 Node.js 또는 Electron module을 import하지 않으므로 `isDesktopOnly`는 `false`입니다. iOS 또는 Android에서의 모바일 지원은 아직 완전히 테스트되지 않았습니다.
